...
#define LOG_TRACE if (shynet::utils::Logger::loglevel() <= shynet::utils::Logger::LogLevel::TRACE) \
	shynet::utils::Logger(__FILE__, __LINE__, shynet::utils::Logger::LogLevel::TRACE, __func__).stream()
#define LOG_DEBUG if (shynet::utils::Logger::loglevel() <= shynet::utils::Logger::LogLevel::DEBUG) \
	shynet::utils::Logger(__FILE__, __LINE__, shynet::utils::Logger::LogLevel::DEBUG, __func__).stream()
#define LOG_LUA if (shynet::utils::Logger::loglevel() <= shynet::utils::Logger::LogLevel::LUA) \
