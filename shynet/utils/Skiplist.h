...
#define SKIPLIST_ITERATOR_COMMON_SNIPPET(T) \
  public: \
  ...
  private: \
    node *node_ = nullptr;
            /// } end of macro SKIPLIST_ITERATOR_COMMON_SNIPPET

        public:
            class iterator {
                SKIPLIST_ITERATOR_COMMON_SNIPPET(iterator);
            ...
            class reverse_iterator {
                SKIPLIST_ITERATOR_COMMON_SNIPPET(reverse_iterator);
        ...
        public:
            void debug_print() {
                ...
                std::cout << "-----" << std::endl;
                Skiplist<int, int>::iterator iter;
                iter = begin();
                for (; iter != end(); ++iter) {
