...
namespace utils {
    namespace filepathop {
        ...
        int write_file(const std::string& filename, const std::string& content, bool append)
        {
            return write_file(filename, content.c_str(), content.length(), append);
        }
        int write_file(const std::string& filename, const char* content, size_t content_size, bool append)
        {
        ...
        int64_t read_file(const std::string& filename, char* content, size_t content_size)
        {
