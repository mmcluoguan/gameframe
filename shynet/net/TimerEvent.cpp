...
namespace net {
    ...
    const timeval& TimerEvent::val() const { return val_; }
    ...
    short TimerEvent::what() const { return what_; }

    int TimerEvent::timerid() const { return timerid_; }

    void TimerEvent::set_timerid(int timerid) { timerid_ = timerid; }
