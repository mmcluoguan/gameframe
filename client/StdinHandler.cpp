...
void StdinHandler::input(int fd)
{
    ...
    if (ret < 0) {
        ...
        item orders[] = {
            item("quit", ":", bind(&StdinHandler::quit_order, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4)),
            item("info", ":", bind(&StdinHandler::info_order, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4)),
            item("reconnect", ":", bind(&StdinHandler::reconnect_order, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4)),
            item("login", ":p:", bind(&StdinHandler::login_order, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4)),
        };
